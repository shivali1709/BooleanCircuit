...
static void NandGate_update(Gate *this) {
	Boolean_setValue(this->output, !(Boolean_getValue(this->inputs[0]) && Boolean_getValue(this->inputs[1])));	//Inverts AND gate output
}
...
static void NorGate_update(Gate *this) {
	Boolean_setValue(this->output, !(Boolean_getValue(this->inputs[0]) || Boolean_getValue(this->inputs[1])));	//Inverts OR gate output
}
